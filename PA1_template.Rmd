...
The following 5-minute interval (on average) contains the max number of steps: `r maxStepsInt`
...
```
The total number of missing values is `r misValCount`.  
The mean steps per day (NAs replaced with Avg Steps/5 Min Interval)  is `r meanStepsPerDay`.  
The median steps per day (NAs replaced with Avg Steps/5 Min Interval) is `r medianStepsPerDay`.
